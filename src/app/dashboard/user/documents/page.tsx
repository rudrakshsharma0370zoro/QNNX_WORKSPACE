...
export default function UserDocuments() {
  ...
  const [selectedCategory, setSelectedCategory] = useState('task-files');
    ...
    <div className="font-sans text-gray-800 bg-[#F8FAFC] p-6 lg:p-8 min-h-full w-full">
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-[13px] text-gray-500 mt-1">Upload and manage your personal files securely via S3.</p>
        </div>
                  ...
                  filteredDocs.map((doc, idx) => (
                    <tr key={doc.id || idx} className="hover:bg-gray-50/50 transition-colors group">
                      ...
                      <td className="px-6 py-4 text-center">
                        <span className={`px-2 py-0.5 text-[10px] font-bold rounded bg-gray-100 border border-gray-200 text-gray-500`}>

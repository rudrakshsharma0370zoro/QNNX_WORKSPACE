...
import { DatabaseBackup, ChevronDown, Plus } from 'lucide-react';
      ...
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Manage database snapshots and restores.</p>
          </div>
        ...
        <div className="bg-white p-12 rounded-2xl border border-gray-200 shadow-sm flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">Backup & Recovery Module Active</h3>

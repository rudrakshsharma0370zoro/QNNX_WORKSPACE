...
export default function AdminDocuments() {
  ...
  const storageCategories = [
    { name: 'policies', tier: 'Company-wide' },
    ...
    { name: 'employee-records', tier: 'Confidential' },
    { name: 'company-confidential', tier: 'Confidential' },
    ...
    <div className="font-sans text-gray-800 bg-[#F8FAFC] p-6 lg:p-8 min-h-full w-full">
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-[13px] text-gray-500 mt-1">Upload and manage your files securely via S3.</p>
        </div>
